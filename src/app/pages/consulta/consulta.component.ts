...
export class ConsultaComponent implements OnInit {
  ...
  constructor(private __ventaService: VentaService, public dialog: MatDialog) {}
  ...
  buscar() {
    ...
    if (filtro.fechaConsulta) {
      //para asegurarme y obtener desde el inicio del dia - final del dia
      // osea seteo para poder solo tener la fecha
      ...
      this.__ventaService.buscar(filtro).subscribe(data => {
